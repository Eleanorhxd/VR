...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default=r'D:\MKCLA\data\iu_xray\images',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default=r'D:\MKCLA\data\iu_xray\annotation.json',
                        help='the path to the directory containing the data.')
    parser.add_argument('--vocab-path', type=str, default=r'D:\MKCLA\data\vocab.pkl')
    # Data loader settings
    parser.add_argument('--dataset_name', type=str, default='iu_xray', choices=['iu_xray', 'mimic_cxr'],
                        help='the dataset to be used.')
    parser.add_argument('--max_seq_length', type=int, default=57, help='the maximum sequence length of the reports.') #60
    ...
    parser.add_argument('--temperature', type=float, default=0.1, help='the temperature when sampling.') # 1.0
    ...
    parser.add_argument('--save_dir', type=str, default=r'D:\MKCLA\results\iu_xray', help='the patch to save the models.')
    parser.add_argument('--record_dir', type=str, default=r'D:\MKCLA\records', help='the patch to save the results of experiments.')
...
def main():
    ...
    embs = read_word_embeddings(r"D:\MKCLA\data\embedding\glove.6B.200d-relativized.txt")
    #print(embs.vectors)
    ...
    trainer = Trainer(model,fw_adj, bw_adj, criterion, criterion_c, metrics, optimizer, args, lr_scheduler, train_dataloader, val_dataloader, test_dataloader)
    trainer.train()
